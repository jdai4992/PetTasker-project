...
<div id="backgroundImage">
	<div class="register-page">
		<div class="form">		  
			<div class="loginRegisterTitle">Register</div>
			<hr>
			...
			<form:form commandName="user" >
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<div class="inputFields">Confirm Email</div>
						<div class="input-group">
							<span class="input-group-addon">
								<span class="glyphicon glyphicon-envelope"></span>
							</span>
							<form:input placeholder="Confirm Email" path="confirmEmail" class="form-control" />
						</div>
